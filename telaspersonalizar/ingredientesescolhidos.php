...
// Valores padrão caso nada seja encontrado
    $peso = "Peso não selecionado";
    $massa = "Massa não selecionada";
    $recheio1 = "Sem recheio";
    $recheio2 = "Sem recheio secundário";
...
<body>
    ...
    <div class="novidades">
        <h1><br>Ingredientes Escolhidos<img src="../assets/img/Icons/bolo-de-casamento.png" class="mx-2 icon" width="30px" height="30px"></h1>
    </div>
    <!-- Fim Div Personalizar -->

    <!-- Personalizar -->
    <br><div class="container">
        <div class="campoescolhadiv align-content-start">
