...
<head>
    ...
    <title>Personalizar - NC Bolos</title>
</head>
<body>
    <!-- Início NavBar-->
    ...
    <div class="container"> 
        <div class="campoescolhadiv">
            <br><br><img src="../assets/img/Icons/bolo.png" width="100px" height="100px">
            <p class="infprimaria"><br><br>Faça o bolo do seu jeito!</p>
            <br><div class="botoes">
                <a href="../telaspersonalizar/tamanho.html"><button type="button" class="btnconfirmar">COMEÇAR</button></a>
            </div>
        </div>
    </div>
    <!-- Fim Personalizar -->
