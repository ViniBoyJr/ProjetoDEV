...
// Valores padrão caso nada seja encontrado
    ...
    if ($linha) {
        if (!empty($linha["login_email"])) {
            $email = $linha["login_email"];
        }
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/editarconta.css">
    <link rel="icon" href="../assets/img/Logo/NC-Bolos-Pequeno.png" type="image/x-icon">
    <title>Editar Conta - NC Bolos</title>
</head>
<body>
    <!-- Início NavBar-->
    ...
    <!-- Início Minha Conta -->
    <div class="novidades">
        <h1>Editar Conta<img src="../assets/img/Icons/person_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.png" class="mx-2 sale icon"></h1>
    </div>
    <!-- Fim Minha Conta -->

    <!-- Início Minha Conta (container) -->
    <br>
    <div class="container text-center">
        <img src="<?= htmlspecialchars($imagem); ?>" class="ellipse">
        <h2><br><?php echo $nome_usuario; ?></h2>
        <h3><?= htmlspecialchars($email); ?></h3>
    </div>
    <!-- Começo do Container Forms-->
    <div class="container"> 
        <form class="forms">
            <div class="mb-3 ">
                <label for="exampleInputName1" class="form-label infprimaria"><img src="../assets/img/Icons/edit_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png" width="24px" height="24px">&nbsp Editar Nome</label><br>
                <input type="email" id="exampleInputName1" aria-describedby="emailHelp" placeholder="<?php echo $nome_usuario; ?>">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label infprimaria"><img src="../assets/img/Icons/edit_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png" width="24px" height="24px">&nbsp Editar E-mail</label><br>
                <input type="email" id="exampleInputEmail1" placeholder="<?= htmlspecialchars($email); ?>">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label infprimaria">Nova Senha</label><br>
                <input type="email" id="exampleInputEmail1">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label infprimaria">Confirmar Nova Senha</label><br>
                <input type="email" id="exampleInputEmail1">
            </div>
            <br>
            <div class="botoes">
                <a href="./minhaconta.php"><button type="button" class="btnvoltar">VOLTAR</button></a>
                <a href="#"><button type="button" class="btnconfirmar">SALVAR</button></a>
            </div>

        </form>
    </div> 
    <!-- Fim do Container Forms -->
    
    <!-- Fim Minha Conta (container) -->
