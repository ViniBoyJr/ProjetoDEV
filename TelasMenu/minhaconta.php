...
<head>
    ...
    <title>Minha Conta - NC Bolos</title>
</head>
<body>
    <!-- Início NavBar-->
    ...
    <!-- Início Minha Conta -->
    <div class="novidades">
        <h1>Minha Conta<img src="../assets/img/Icons/person_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.png" class="mx-2 icon"></h1>
    </div>
    <!-- Fim Minha Conta -->
    ...
    <div class="container text-center">
        ...
        <h3 style="font-weight: 500;"><br><?php echo $nome_usuario; ?></h3>
    ...
    <div class="container quadrado">
        <div class="row">
            ...
            <div class="col-4 text-center items">
                <a href="#" class="descricao text-dark"><img src="../assets/img/Icons/notifications_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png">
                <p class="my-2">Notificações</p></a>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <a href="./configuracoes.php" class="text1"><div class="container retangulo">
        <div class="row">
            <div class="col-6 text-start text-dark">
                <img src="../assets/img/Icons/settings_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png">&nbsp&nbsp&nbsp&nbsp Configurações
            </div>
            <div class="col-6 text-end">
                <img src="../assets/img/Icons/chevron_right_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png">
            </div>
    ...
    <a href="#" class="text1"><div class="container retangulo">
        <div class="row">
            <div class="col-6 text-start text-dark">
                <img src="../assets/img/Icons/support_agent_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png">&nbsp&nbsp&nbsp&nbsp Central de Atendimento
            </div>
            <div class="col-6 text-end">
                <img src="../assets/img/Icons/chevron_right_40dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png">
            </div>
